...
export default function CommunityPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center lg:flex-row w-full lg:w-3/4 mx-auto p-2 gap-4">
      {/* Desktop View */}
      <div className="hidden lg:flex flex-col lg:flex-row w-10/12 gap-4 mt-2">
        {/* Left Side */}
              ...
              <div key={post.id} className="bg-[#30313b] p-10 pt-8 rounded-md">
                <div className="flex flex-row justify-between">
                  ...
                  <div className="">
                    <FontAwesomeIcon
                      icon={faBookmark}
                      className="text-purple-300 text-xl pr-3"
                    />
                  </div>
                </div>
                <hr className="border-[1px] mt-2 rounded-md border-[#cac8ff]" />
                ...
                <div className="flex flex-row items-center mt-5 text-gray-400 gap-6 justify-between">
