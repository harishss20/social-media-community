...
export default function LoginPage() {
    ...
    useEffect(() => {
      ...
      setErrors(newErrors);
      (touched.email || touched.password) && setIsFormValid(Object.keys(newErrors).length === 0);
    ...
    return (
        <div className="mainContainer">
            ...
            <div className="">
                ...
                <button type="submit" className="loginButton mt-3 bg-[#ff3d3d]" disabled={!isFormValid} onSubmit={handleSubmit}>Log In</button>
